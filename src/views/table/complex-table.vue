<template>
  <div class="app-container">
    ...
    <div class="filter-container">
      ...
      <el-checkbox v-model="showReviewer" class="filter-item" style="margin-left:15px;" @change="handleFilter">
        可用
      </el-checkbox>
    </div>
    ...
    >
      ...
      <!-- <el-table-column v-if="showReviewer" label="可用" width="110px" align="center">
        <template slot-scope="{row}">
          <span style="color:red;">{{ row.reviewer }}</span>
        </template>
      </el-table-column> -->
      <el-table-column label="人数上限" align="center" width="95">
        <template slot-scope="{row}">
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
      <el-form ref="dataForm" :rules="rules" :model="temp" label-position="left" label-width="70px" style="width: 400px; margin-left:50px;">
        ...
        <el-form-item label="时间" prop="timestamp">
          <el-date-picker v-model="temp.timestampB" type="datetime" placeholder="请选择开始时间" />
          <el-date-picker v-model="temp.timestampE" type="datetime" placeholder="请选择结束时间" />
        </el-form-item>
